...
def sign_xml_with_windows_store(xml_file, output_file=None, **kwargs):
    ...
    try:
        ...
        signature_info = SignatureInfo(
            signature_id=kwargs.get('sig_id', 'ManageX-Signature'),
...
def sign_xml_with_pfx(xml_file, pfx_file, password=None, output_file=None, **kwargs):
    ...
    try:
        ...
        signature_params = SignatureEnvelopeParameters.create_default(kwargs.get('sig_id', 'ManageX-PFX-Signature'))
...
def sign_xml_with_hsm(xml_file, pin=None, dll_path=None, output_file=None, **kwargs):
    ...
    try:
        ...
        # Use default signature parameters
        signature_params = SignatureEnvelopeParameters.create_default(kwargs.get('sig_id', 'ManageX-HSM-Signature'))
