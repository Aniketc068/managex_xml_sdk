...
class SignatureEnvelopeParameters:
    ...
    @classmethod
    def create_default(cls, signature_id: str = "ManageX-Signature"):
        """Create default signature envelope parameters"""
        return cls(
            signature_info=SignatureInfo(signature_id=signature_id),
            reference_info=ReferenceInfo(),
            key_info=KeyInfo()
        )